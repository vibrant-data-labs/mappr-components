...
export const CheckIcon = (props?: React.SVGAttributes<SVGSVGElement>) => {
    return <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" height="16px" width="16px" version="1.1" viewBox="0 0 78.369 78.369" xmlSpace="preserve" {...(props || {})}>
        <g>
